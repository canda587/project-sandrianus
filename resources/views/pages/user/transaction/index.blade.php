                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-wrap order-status-tab">
                                    <a href="/user/transactions" class="{{ (!isset($_GET['status'])) ? "active" : "" }} mb-2 ms-2 me-2"><i class="fa-brands fa-shopify me-2"></i>All Transaction</a>
                                    <a href="/user/transactions?status=order-complete" class="{{ (isset($_GET['status']) && $_GET['status'] == "order-complete") ? "active" : "" }} mb-2 ms-2 me-2"><i class="fa-solid fa-check me-2"></i>Transaction Complete</a>
                                    <a href="/user/transactions?status=order-cancelled" class="{{ (isset($_GET['status']) && $_GET['status'] == "order-cancelled") ? "active" : "" }} mb-2 ms-2 me-2"><i class="fa-solid fa-ban me-2"></i>Transaction Cancelled</a>
                                </div>
                            </div>
                        </div>
                    </div>  
                                                ...
                                                <div class="col-12">
                                                    <div class="row">
                                                        <div class="offset-lg-9 col-lg-3">
                                                            <a href="/user/transactions/{{ $order->code }}" class="btn main-btn">show Detail</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
